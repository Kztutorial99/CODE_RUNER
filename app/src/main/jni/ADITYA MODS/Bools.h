...
// 1. Agar Unity/Vector3.hpp project mein hai, toh ise include karein taaki Vector3 mil sake
#include "Unity/Vector3.hpp" 

// 2. Extern declarations
extern int g_GlWidth;
extern int g_GlHeight;

// [REMOVED DUPLICATE STRUCT VECTOR3] -> Isko yahan se hata diya kyunki yeh already Unity/Vector3.hpp mein hai.
